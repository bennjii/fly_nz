        ...
        <div className={articleStyles.articleContainer}>
            ...
            <StickyContainer className={articleStyles.article}>
                ...
                <section className={articleStyles.articleBody}>
                    <div className={articleStyles.dropBox} onDrop={(e) => {
                        e.preventDefault();
                            ...
                            for (let i = 0; i < e.dataTransfer.items.length; i++) {
                              if (e.dataTransfer.items[i].kind === 'file') {
                                ...
                                reader.onload = function(e) {
                                    if(file) {
                                        setInformationUpdated(false);
                                        const content: string = JSON.parse(reader.result as string);

                                        debounceStorageUpdate({ ...articleData, content: content }, INDEX, (e) => {
                                            if(e.error) {
                                                setSyncFailed(true);
                                                return;
                                            }else {
